...
if (isset($_POST['myinsert'])) {
    ...
    if (!in_array($extension, $accept)) {
        ...
        $insertQuery = "INSERT INTO products(title,description,price,dicscount,image,category_id) VALUES('$title','$description',$price,$discount,'$image','$category_id')";
                ...
                <form action="insert.php" method="POST" enctype="multipart/form-data">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class=" col-md-6">
                                <label for="discount">الاقسام</label>
                                <?php
                                $myQuery = "SELECT * FROM categories";
                                $categories =  mysqli_query($connection, $myQuery);
                                ?>
